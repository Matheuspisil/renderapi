...
class Mentor(models.Model):
    ...
    profissao = models.CharField(max_length=100, verbose_name='Profissão') #ia
    experiencia_profissional = models.CharField(max_length=255, verbose_name='Experiência') #ia
